...
from AnimalCnn import AnimalDataset
...
def get_args():
    ...
    parser.add_argument("--root", "-r", type=str, default='D:\Code Pytorch\Data\Animal', help="Path data")
...
if __name__ == '__main__':
    ...
    test_dataset = AnimalDataset(root=args.root,train=False, transform=test_transforms)
